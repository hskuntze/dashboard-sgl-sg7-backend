package br.mil.eb.dashboard_sgl_sg7.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	private static final String[] PUBLIC = { 
		...
		"/usuarios/redirecionarParaTrocarSenha",
		"/salvarTrocaDeSenha", // Redirecionamento para trocar senha.
		"/oms",
		"/postos"
	};
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests(requests -> requests
				...
				.antMatchers("/patrimonios/**").hasAnyAuthority("PERFIL_ADMIN", "PERFIL_OPERADOR_OM", "PERFIL_SLI")
				.antMatchers("/usuarios/atualizar/**", "/usuarios/deletar/**").hasAuthority("PERFIL_ADMIN")
				.antMatchers("/materiais/**").hasAnyAuthority("PERFIL_ADMIN", "PERFIL_SLI")
